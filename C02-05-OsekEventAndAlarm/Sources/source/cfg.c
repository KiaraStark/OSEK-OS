...
OSBYTE  taskStack[OCC_NTSKS][TASK_STACK_SIZE]; //task stacks
...
{
    CONFIG_OSEK_TASK_PRIORITY_NUMBER - 1, // R1
    CONFIG_OSEK_TASK_PRIORITY_NUMBER - 1, // R2
    CONFIG_OSEK_TASK_PRIORITY_NUMBER - 1  // R3
};
...
{
    { Task2, 0, SysCounter },     // Alarm1 activates Task2
    { Task3, 0, SysCounter },     // Alarm2 activates Task3
    { Task4, 0, SysCounter },     // Alarm3 activates Task4
    { Task5, 0, SysCounter },     // Alarm4 activates Task5
    { Task6, 0x01, SysCounter },  // Alarm5 sets event 0x01 for Task6
    { Task7, 0x01, SysCounter },  // Alarm6 sets event 0x01 for Task7
    { Task8, 0x01, SysCounter },  // Alarm7 sets event 0x01 for Task8
    { Task9, 0x01, SysCounter }   // Alarm8 sets event 0x01 for Task9
};
...
T_OSEK_MESSAGE_ConfigTable_Struct osekConfig_MsgTable[OCC_NMSGS] =
{
   ...
   {
        1,                       //ID
        &messageBuf[1],          //message butter
        sizeof(messageBuf[1])   //size of the message buffer
   }
};
