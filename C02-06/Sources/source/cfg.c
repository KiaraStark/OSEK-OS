...
{
	//Alarm1 activates Task2 with event 0x01
	{
		Task2,
	...
	//Alarm2 activates Task3 with event 0x02
	{
		Task3,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x02,
	...
	//Alarm3 activates Task4 with event 0x03
	{
		Task4,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x03,
	...
	//Alarm4 activates Task5 with event 0x04
	{
		Task5,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x04,
	...
	//Alarm5 activates Task6 with event 0x05
	{
		Task6,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x05,
	...
	//Alarm6 activates Task7 with event 0x06
	{
		Task7,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x06,
	...
	//Alarm7 activates Task8 with event 0x07
	{
		Task8,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x07,
	...
	//Alarm8 activates Task9 with event 0x08
	{
		Task9,
#if (defined(OCC_ECC1) || defined(OCC_ECC2)) && defined(OCC_ALMSETEVENT)
		0x08,
