...
const		T_OSEK_TASK_ConfigTable_Struct		osekConfig_TaskTable[OCC_NTSKS]=	
{
	...
	/*Task13	ID:12 priority:CONFIG_OSEK_TASK_PRIORITY_NUMBER-6-1 */
	{
	...
	/*Task15	ID:14 priority:CONFIG_OSEK_TASK_PRIORITY_NUMBER-6-1 */
	{
	...
	/*Task16	ID:15 priority:CONFIG_OSEK_TASK_PRIORITY_NUMBER-6-1 */
	{
	...
	/*Task17	ID:16 priority:CONFIG_OSEK_TASK_PRIORITY_NUMBER-6-1 */
	{
	...
	/*Task18	ID:17 priority:CONFIG_OSEK_TASK_PRIORITY_NUMBER-6-1 */
	{
